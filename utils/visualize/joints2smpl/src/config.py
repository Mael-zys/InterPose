...
import os
SMPL_MODEL_DIR = os.path.expanduser("data/smpl_all_models/smpl/")
GMM_MODEL_DIR = "./utils/visualize/joints2smpl/smpl_models/"
SMPL_MEAN_FILE = "./utils./visualize/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "./utils./visualize/joints2smpl/smpl_models/smplx_parts_segm.pkl"